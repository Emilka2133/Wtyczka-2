...
SOURCES = \
	__init__.py \
	modul_inf.py modul_inf_dialog.py

PLUGINNAME = modul_inf

PY_FILES = \
	__init__.py \
	modul_inf.py modul_inf_dialog.py

UI_FILES = modul_inf_dialog_base.ui
...
QGISDIR=C:\Users\JA\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
